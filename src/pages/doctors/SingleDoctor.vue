  ...
  <div v-else class="container py-5">
    ...
    <div v-if="doctorFound">
      ...
      <div class="d-flex flex-wrap gap-3">
        ...
        <img :src="thumbnail" style="width: 250px; object-fit:cover" alt="doctor profile pic" @error="thumbnailError" />

        <div id="details-container">
          <div>
            <label for="__mainspec"><strong>Specializzazione principale: </strong></label>
            <div id="__mainspec">
              {{ doctor.mainspec }}
            </div>
          </div>
          ...
          <div>
            <label for="__other-specs"><strong>Altre specializzazioni: </strong></label>
            <ul id="__other-specs">
          ...
          <div class="mb-4">
            <label for="__phone-number"><strong>Numero di telefono: </strong></label>
      ...
      <form action="" method="POST" @submit.prevent="sendMessage" class="mb-2">
        <div>
          ...
          <div>
            <input id="name" type="text" class="form-control" name="name" v-model="formData.name" required minlength="3"
              maxlength="50" autocomplete="name" autofocus />
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            <input id="email" type="email" class="form-control" name="email" v-model="formData.email" required
              minlength="3" maxlength="500" autocomplete="email" autofocus />
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            <input id="subject" type="text" class="form-control" name="subject" v-model="formData.subject" required
              minlength="3" maxlength="100" autocomplete="subject" autofocus />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mb-3">
            <textarea id="message" class="form-control" name="message" v-model="formData.message" required minlength="3"
      ...
      <form action="" method="POST" @submit.prevent="sendReview" class="mb-2">
        <div>
          ...
          <div>
            <input id="name" type="text" class="form-control" name="name" v-model="formReview.name" minlength="3"
              maxlength="50" autocomplete="name" autofocus />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mb-3">
            <textarea id="description" class="form-control" name="description" v-model="formReview.description" required
      ...
      <form action="" method="POST" @submit.prevent="sendVote" class="mb-2 __main-color">
        <div>
          <label for="voter" class="col-md-4 col-form-label text-md-right">Nome</label>

          <div>
            <input id="voter" type="text" class="form-control" name="voter" v-model="formVote.voter" minlength="3"
              maxlength="50" autocomplete="voter" autofocus />
          </div>
        </div>

        <div>
          <label for="vote" class="col-md-4 col-form-label text-md-right __main-color">Voto *</label>

          <div class="mb-3">
            <select class="form-select __main-color" name="vote" id="vote" v-model="formVote.vote" required>
          ...
          <div v-if="showMenu">
            <ul>
              <li v-for="rev in doctor.reviews">
                <label for="__reviewer-name"><strong>Recensore: </strong>
                </label>
...
hr {
  ...
  border-top: 3px solid #0c192f;
  /* Set the thickness and color of the top border */
}
